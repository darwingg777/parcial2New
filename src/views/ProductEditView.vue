  ...
  <div class="content-area">
    ...
    <div class="welcome-section">
      <div class="welcome-content">
        ...
        <p class="welcome-subtitle">Actualiza la información del producto</p>
      </div>
    ...
    <!-- Product Form -->
    <div v-if="!loading && product" class="form-container">
      ...
      <form @submit.prevent="handleSubmit" class="product-form">
        ...
        <div class="info-section">
          ...
          <div class="info-item" v-if="product.updatedAt">
            ...
            <span>Última actualización: {{ formatDate(product.updatedAt) }}</span>
          </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content futuristic-modal">
        ...
        <div class="modal-body">
          <p class="mb-2">¿Estás seguro de que deseas descartar los cambios?</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content futuristic-modal">
        ...
        <div class="modal-body text-center">
          ...
          <p class="mb-0">El producto se ha actualizado exitosamente</p>
        </div>
  ...
  setup() {
    ...
    const load = async () => {
      ...
      try {
        ...
        error.value = 'Error cargando el producto: ' + (err.message || err)
        console.error(err)
      } finally {
        loading.value = false
      }
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        await apiService.products.updateProduct(id, payload)
        ...
        error.value = 'Error actualizando producto: ' + (err.message || err)
        console.error(err)
